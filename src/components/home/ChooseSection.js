            ...
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row">
                    <div className="w-full" >
                        <img width="100%" height="100%" layout="responsive" objectFit="contain" src="https://themefie.com/html/foodka/assets/img/other/about.png" alt='' className="rounded-lg" />
                    </div>
                    <div className='text-center lg:text-left lg:w-full'>
                        <h1 className="text-[#dc3545] mb-4 text-4xl awesome-title header1">Why choose us</h1>
